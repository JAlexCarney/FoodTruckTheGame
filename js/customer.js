var Customer = function(game, type){
	if(type == 0){
		...
		Phaser.Sprite.call(this, game, 0, -96, 'atlas', 'customer_bird');
		console.log("bird");
	}else if(type == 2){
		Phaser.Sprite.call(this, game, 0, -96, 'atlas', 'customer_frog');
		console.log("frog");
	}else if(type == 3){
		Phaser.Sprite.call(this, game, 0, -96, 'atlas', 'customer_axolotl');
		console.log("axolotl");
	}
}
